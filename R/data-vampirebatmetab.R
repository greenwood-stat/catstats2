#' Data from a repeated measures study on vampire bats
#'
#' Results of a study of 24 bats on metabolism based on different diet types.
#'
#' Data contains static demographic file in slot 1 (`bat_demo`) and wide file containing
#' repeated measures in slot 2 (`bat_metab`).
#'
#' Code demonstrates `left_joining` and then pivoting the data for VCO2, similar
#' code can be used for VO2 measurements - see original papers for more details
#'
#' @format a list of data.frames with many observations on multiple variables from 24 subjects:
#' \describe{
...
#' }
#'
#' @name vampirebatmetab
#' @docType data
#' @references  Rossi GS, Welch KC. 2024 Vampire bats rapidly fuel running with essential or non-essential amino acids from a blood meal. Biology Letters. 20: 20240453. https://doi.org/10.1098/rsbl.2024.0453
#' @references Rossi Giulia S. and Welch Kenneth C. 2025 Correction: ‘Vampire bats rapidly fuel running with essential or non-essential amino acids from a blood meal’ (2024), by Rossi and WelchBiol. Lett.2120250088 http://doi.org/10.1098/rsbl.2025.0088
#' @source Rossi, Giulia S; Welch, Kenneth C (2024). Supplementary material from "Vampire bats rapidly fuel running with essential or non-essential amino acids from a blood meal". The Royal Society. Collection. https://doi.org/10.6084/m9.figshare.c.7524683.v1
#' @keywords data metabolism bats repeated measures mixed models
#' @examples
#' library(ggthemes)
#' library(dplyr)
#' library(ggplot2)
