...
#' intplot_gg(measurevar = "age", groupvars = c("sex", "survived"), data = TitanicSurvival, na.rm = T, conf.level = 0.9, array = T)
#' intplot_gg(measurevar = "age", groupvars = c("sex", "survived"), data = TitanicSurvival, na.rm = T, conf.level = 0.9, array = F)
#' intplot_gg(measurevar = "age", groupvars = c("sex", "survived", "passengerClass"), data = TitanicSurvival, na.rm = T, conf.level = 0.9, array = F)
#' intplot_gg(measurevar = "age", groupvars = c("sex", "survived", "passengerClass"), data = TitanicSurvival, na.rm = T, conf.level = 0.9, array = T, ptalpha = .5, pd = .5)
#' intplot_gg(data = TitanicSurvival, measurevar = "age", groupvars = "sex", na.rm = T, conf.level = 0.95)
                        ...
                        conf.level=.95, .drop=TRUE, pd = 0.1, array = T, ptalpha = 0.3)
{
  ...
  if(numberXs == 1){
    ...
    plot1 <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[1]]], y = .data[[measurevar]], color = .data[[groupvars[1]]]), alpha = 0.3) +
      geom_jitter(aes(x = .data[[groupvars[1]]], y = .data[[measurevar]], color = .data[[groupvars[1]]]), alpha = ptalpha) +
  ...
  if(numberXs == 2 & array == T){
    ...
    plotUL <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[1]]], y = .data[[measurevar]], color = .data[[groupvars[2]]]), alpha = 0.3, position = pd) +
      geom_jitter(aes(x = .data[[groupvars[1]]], y = .data[[measurevar]], color = .data[[groupvars[2]]]), alpha = ptalpha, position = pd) +
    ...
    summaryinfo_LL <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[[1]], na.rm = na.rm, conf.level = conf.level)
    ...
    plotLR <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[2]]], y = .data[[measurevar]], color = .data[[groupvars[1]]]), alpha = 0.3, position = pd) +
      geom_jitter(aes(x = .data[[groupvars[2]]], y = .data[[measurevar]], color = .data[[groupvars[1]]]), alpha = ptalpha, position = pd) +
    ...
    summaryinfo_UR <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[[2]], na.rm = na.rm, conf.level = conf.level)

    plotUR <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[2]]], y = .data[[measurevar]], color = .data[[groupvars[2]]]), alpha = 0.3) +
      geom_jitter(aes(x = .data[[groupvars[2]]], y = .data[[measurevar]], color = .data[[groupvars[2]]]), alpha = ptalpha) +
  ...
  if(numberXs == 3 & array == T){
    ...
    summaryinfo_11 <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[[1]], na.rm = na.rm, conf.level = conf.level)
    summaryinfo_22 <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[[2]], na.rm = na.rm, conf.level = conf.level)
    summaryinfo_33 <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[[3]], na.rm = na.rm, conf.level = conf.level)
    summaryinfo_12 <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[1:2], na.rm = na.rm, conf.level = conf.level)
    summaryinfo_13 <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[c(1,3)], na.rm = na.rm, conf.level = conf.level)
    summaryinfo_23 <- summarySE(data = data, measurevar = measurevar, groupvars = groupvars[2:3], na.rm = na.rm, conf.level = conf.level)
    ...
    plot33 <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[3]]], y = .data[[measurevar]], color = .data[[groupvars[3]]]), alpha = 0.3) +
      geom_jitter(aes(x = .data[[groupvars[3]]], y = .data[[measurevar]], color = .data[[groupvars[3]]]), alpha = ptalpha) +
    ...
    plot13 <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[1]]], y = .data[[measurevar]], color = .data[[groupvars[3]]]), alpha = 0.3, position = pd) +
      geom_jitter(aes(x = .data[[groupvars[1]]], y = .data[[measurevar]], color = .data[[groupvars[3]]]), alpha = ptalpha, position = pd) +
    ...
    plot31 <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[3]]], y = .data[[measurevar]], color = .data[[groupvars[1]]]), alpha = 0.3, position = pd) +
      geom_jitter(aes(x = .data[[groupvars[3]]], y = .data[[measurevar]], color = .data[[groupvars[1]]]), alpha = ptalpha, position = pd) +
    ...
    plot23 <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[2]]], y = .data[[measurevar]], color = .data[[groupvars[3]]]), alpha = 0.3, position = pd) +
      geom_jitter(aes(x = .data[[groupvars[2]]], y = .data[[measurevar]], color = .data[[groupvars[3]]]), alpha = ptalpha, position = pd) +
    ...
    plot32 <- data %>% ggplot() +
      geom_violin(aes(x = .data[[groupvars[3]]], y = .data[[measurevar]], color = .data[[groupvars[2]]]), alpha = 0.3, position = pd) +
      geom_jitter(aes(x = .data[[groupvars[3]]], y = .data[[measurevar]], color = .data[[groupvars[2]]]), alpha = ptalpha, position = pd) +
