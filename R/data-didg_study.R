#' Data from trial of playing didgeridoo/not on sleepiness
#'
...
#'
#'
#' @format a \code{data.frame} with 50 observations on 4 variables from 25 subjects:
#' \describe{
...
#' @name didg_study
#' @docType data
#' @references Puhan M A, Suarez A, Cascio C L, Zahn A, Heitz M, Braendli O et al. Didgeridoo playing as alternative treatment for obstructive sleep apnoea syndrome: randomised controlled trial BMJ 2006; 332 :266 doi:10.1136/bmj.38705.470590.55
#' @source Digitized version of published Figure 3 (does not exactly match published numerical summaries!)
#' @keywords data epworth didgeridoo repeated measures
#' @examples
#' library(ggthemes)
#' library(tidyverse)
