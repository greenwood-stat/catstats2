#' Daily weather data from MSU-Bozeman weather station from 1893 to 2022
#'
...
#'
#'
#' @format a \code{data.frame} with 46603 observations on 6 variables:
#' \describe{
